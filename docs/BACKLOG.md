...
| **X 20時投稿** | 急上昇3件のティーザー | 無料（導線）· **一旦停止（2026-07）** |
...
- [x] 夜=X 急上昇 / 朝=AIサマリー（設計時）
- [ ] ~~X 文案とダッシュ CTA の文言統一~~ — **Daily X post series 停止（2026-07）**: GHA・Discord 通知・19時スケジューラ連携を無効化。脚本は手動用に残置。
