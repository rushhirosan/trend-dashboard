...
```
【2026-05-21】今日の急上昇3つ（JP）
① ガザ支援者愚弄の動画投稿 イスラエル閣僚、非難殺到（ニュース）
② 複数集約を跨ぐ処理を1つのDBトランザクションで括る前に読む記事（IT）
③ 大谷翔平（検索）
一覧: https://trends-dashboard.fly.dev/
```
...
```
Today's rising 3 (US) 2026-05-21 · 8pm JST
① House Democrats condemn Texas candidate for antisemitism and… (News)
② 9-Year-Old Linux Kernel Flaw Enables Root Command Execution on… (IT)
③ China’s Xi gives Putin a red-carpet welcome – and makes a… (News)
